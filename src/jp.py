...
for i in range(2000,2023) :
    url1 = 'https://news.google.com/rss/search?q=jp-morgan-chase-stock-' + str(i)
    s= HTMLSession()
    r1=s.get(url1)
...
#print(df)
url='https://drive.google.com/file/d/1DT1tpRmRaocVvDRaP1_gJUEIuJnHU0cy/view?usp=sharing'
...
final.to_csv("C:\\Users\\varsh\\OneDrive\\Documents\\GitHub\\hackutd\\outputjp.csv")
